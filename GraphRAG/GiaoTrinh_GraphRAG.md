...
*Mục tiêu: Hiểu rõ khái niệm, không viết code phức tạp, định hình tư duy Đồ thị.*

### Bài 1.1: Ôn tập RAG Truyền thống & Nỗi đau của Vector Search
...
### Bài 1.2: Nhập môn Sơ đồ Tri thức (Knowledge Graph - KG)
...
*Mục tiêu: Tự code một hệ thống GraphRAG từ đầu để hiểu cơ chế hoạt động, có thể chạy trên tập dữ liệu nhỏ.*

### Bài 2.1: Trích xuất Tri thức (Knowledge Extraction)
...
### Bài 2.2: Xây dựng Knowledge Graph đầu tiên
...
### Bài 2.3: Kỹ thuật Retrieval trên Graph
...
### Bài 2.4: Khai thác các Framework có sẵn
...
*Mục tiêu: Nắm vững hệ thống Microsoft GraphRAG - chuẩn mực hiện tại của ngành.*

### Bài 3.1: Triết lý của Microsoft GraphRAG
...
### Bài 3.2: Graph Communities (Phân cụm đồ thị)
...
### Bài 3.3: Global Search vs Local Search
...
### Bài 3.4: Triển khai Microsoft GraphRAG Open Source
...
*Mục tiêu: Đưa GraphRAG vào Production, giảm chi phí, tăng tính linh hoạt.*

### Bài 4.1: Kiến trúc Hybrid (Vector + Graph)
...
*Mục tiêu: Đủ khả năng đọc hiểu các Paper mới nhất, đánh giá hệ thống và tự thiết kế Framework của riêng bạn.*
